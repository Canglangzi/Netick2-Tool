...
namespace CocKleBurs.GameFrameWork.LagCompensation
{
    ...
    /// </summary>
    internal class LagCompensatedObject : NetworkBehaviour
    {
        ...
        {
            maxFrames =   Orchard.GetMaxFramePoints();
        ...
        public void AddFrame()
        {
            ...
            double time = Sandbox.TickToTime(Sandbox.Tick);
        ...
        public void SetStateTransform(double secondsAgo)
        {
            ...
            double currentTime = Sandbox.TickToTime(Sandbox.Tick);
          ...
          // Debug.Log("TimeAgo: {TimeAgo}, previousTime: {PreviousTime}, nextTime: {NextTime}, lerp: {Lerp}",
